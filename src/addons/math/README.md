...
Use **Check tools** in the addon's settings to check your installation. The tools must be available on your system's `PATH`. Save files included by your document before compiling; Hibi uses the active note's unsaved text.
